...
Administrative Catalyst with proven experience in document control, stakeholder communication, and calendar management. Skilled in Microsoft 365, Google Workspace, and administrative tools. Seeking a QA Engineer position leveraging experience in project coordination, data analysis, and communication to ensure high-quality deliverables. Proficient in Java and eager to learn Kotlin.

\section{Skills}
\begin{itemize}[leftmargin=0.15in, label={}]
\item{
\textbf{Languages}{: Java (Experienced), Kotlin (Must Have)} \\
