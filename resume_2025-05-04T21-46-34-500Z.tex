...
\resumeSubheading{Sample University}{Sample City, ST}{BS Computer Science}{2018-2022}
% Optional: list coursework in a horizontal format, separate by commas
\resumeSubHeadingListEnd

\section{Experience}
\resumeSubHeadingListStart
\resumeSubheading{Sample Company}{2022-Present}{Software Engineer}{Sample City, ST}
\resumeItemListStart
...
\textbf{Frameworks}{: Spring, React, Angular} \\
