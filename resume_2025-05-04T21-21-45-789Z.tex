...
\begin{center}
\textbf{\Huge \scshape Sample Name} \\ \vspace{1pt}
\small 123-456-7890 $|$ \href{mailto:sample@email.com}{\underline{sample@email.com}} $|$
...
This is the professional summary. Just fill with the text about yourself.

\section{Education}
\resumeSubHeadingListStart
\resumeSubheading{Sample University}{City, State}{Degree Name}{Date Range}
% Optional: list coursework in a horizontal format, separate by commas
\resumeSubHeadingListEnd

\section{Experience}
\resumeSubHeadingListStart
\resumeSubheading{Sample Company}{Dates}{Job Title}{Location}
\resumeItemListStart
...
\section{Projects}
\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{Sample Project} $|$ \emph{Technologies}}{Date Range}
\resumeItemListStart
