...
\resumeSubheading{Example University}{City, State}{Bachelor of Science in Example}{2018-2022}
% Optional: list coursework in a horizontal format, separate by commas
\resumeSubHeadingListEnd

\section{Experience}
\resumeSubHeadingListStart
\resumeSubheading{Example Company}{2022-2023}{Software Engineer}{City, State}
\resumeItemListStart
...
\section{Projects}
\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{Example Project} $|$ \emph{Technologies}}{2022}
\resumeItemListStart
